...
else if($action=='make')
{
    ...
    else if($step==10)
    {
		...
		//班S
		require_once(dirname(__FILE__)."/m/canshu.php");
		if($pcwap=='wap'){ShowMsg("WAP手机版更新完成！正初始化参数……","m/ling.php");}
		else if($pcwap=='pc'){ShowMsg("pc手机版更新完成！正初始化参数……","m/ling.php");}
		else if($pcwap=='pcwap'){
		        echo "<script>setTimeout(\"WAP版更新完成\",1000);</script>";
				ShowMsg("pc手机版更新完成！正初始化参数……","m/panduan.php");
				}
		exit();
		//班E
